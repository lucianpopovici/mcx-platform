...
| AMR-WB mandatory for MCPTT clients, EVS optional; the bandwidth-efficient format shall be supported | TS 26.179 4.1.1, 4.1.3 (ETSI TS 126 179 V19.0.0, read online, not archived) | `codec.choose` |
