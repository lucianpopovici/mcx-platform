...
| CA-18 | **From PLT-CONF-AUDIT v1.5.** The Annex A ARP column does not survive PDF extraction, as the 5QI column did not. Emergency Voice and ATP Regular Data ARP values are unconfirmed; the profile carries 1 and 2 respectively, neither transcribed. Needs the same human read that closed CA-16. | FRMCS profile fitness |
