...
| SIP-OP-17 | **Open.** Re-INVITE is not supported. A new INVITE carrying the Call-ID of a call in progress is refused 400 ("Call-ID of a call in progress"): it used to replace the live call in every table keyed by Call-ID (ICD-OP-08 review). Session refresh (RFC 4028, CA-20b) will need in-dialog re-INVITE or UPDATE. | CA-20b |
